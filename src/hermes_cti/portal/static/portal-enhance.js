...
(function () {
  ...
  function buildLoadingSkeleton(title, subtitle, detailMsg, bottomTag) {
    return [
      ...
      '      <div class="relative flex items-center justify-center w-14 h-14 my-1">',
      '        <div class="w-12 h-12 rounded-full border-4 border-sky-200 border-t-sky-600 animate-spin" style="-webkit-animation: spin 0.8s linear infinite; animation: spin 0.8s linear infinite; will-change: transform;"></div>',
